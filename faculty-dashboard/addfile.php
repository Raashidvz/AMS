            ...
            <?php
                ...
                if($data){
                    ...
                    if($module['MODULE_NAME']==null){
                       ...
                       echo "<input type='text' id='title' name='title' placeholder='".$module['MODULE_NAME']."' readonly='readonly'>";
                    }
                }
    ...
    <?php
        if(isset($_POST['addNew'])){
            ...
            if($_SESSION["CATEGORY"]=="NOTE"){
               ...
               $new_file_name = $_SESSION["SUBJECT_NAME"].'_'.$_SESSION["MODULE_NAME"]. '_'. $_SESSION["MODULE"].'_note_'.$date.'.'. $file_extension;
                
                $upload_path = "../notesAndAssignments/NOTES/".$new_file_name;
                ...
                $file_extension = pathinfo($_FILES['fileUpload']['name'], PATHINFO_EXTENSION);
                $new_file_name = $_SESSION["SUBJECT_NAME"].'_'.$module_name. '_'. $_SESSION["MODULE"].'_assignment_'.$date.'.'. $file_extension;
