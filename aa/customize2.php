...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Get DRESS_ID
    $sql1 = "SELECT DRESS_ID FROM dress WHERE dress_style = '$dressStyle'"; // Assuming a dress_style column exists
    $result1 = $conn->query($sql1);
    if ($result1->num_rows > 0) {
        $row = $result1->fetch_assoc();
        $dressId = $row['DRESS_ID'];
        
        echo "DRESS_ID retrieved: " . $dressId; // Debug line to check the value
    
        // Proceed with the insert query
    } else {
        echo "Dress style not found in the database."; // Debugging message
    }
        ...
        $sql = "INSERT INTO customizations (DRESS_ID, FABRIC_ID, COLOR, EMBELLISHMENTS, SIZES, DRESS_LENGTH, SLEEVE_LENGTH, ADDITIONAL_NOTES)
                VALUES ('$dressId', '$fabric', '$color', '$embellishments', '$sizes', '$dresslength', '$sleevelength', '$additionalNotes')";
        ...
        <form id="customization-form" method="POST" action="customize.php">
            ...
            <div class="form-group">
                ...
                <select id="embellishments" name="embellishments" onchange="updatePrice()">
                    ...
                    <option value="applique" data-price="50">APPLIQUÉ - +₹50</option>
                    <option value="lace" data-price="100">LACE - +₹100</option>
                    <option value="fringe" data-price="100">FRINGE - +₹100</option>
                    <option value="pearl" data-price="200">PEARL - +₹200</option>
                    <option value="piping" data-price="50">PIPING - +₹50</option>
                    <option value="rhinestone" data-price="150">RHINESTONE - +₹150</option>
                </select>
