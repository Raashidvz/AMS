                        ...
                        if($subjectTable){
                            ...
                            for($i=0;$i<$rowCount;$i++){
                                ...
                                echo "<tr>
                                        ...
                                        <td>".$teacherName."</td>
                                        <td class='action-btn'><a href='update_subject.php?id=".$key."&tab=manage-teachers' class='update-btn'>Update</a><a href='delete.php?id=".$subject['SUBJECT_ID']."&rolee=subject&tab=manage-subjects' class='delete-btn'>Delete</a></td>
                                    </tr>";
                            }
                        }
