...
<head>
    ...
    <link rel="stylesheet" href="adminDashboard.css" type="text/css">
    <script>
        ...
        <main class="content">
            ...
            <div id="manage-students" class="tab-content">
                ...
                <table>
                    ...
                    <?php
                        $sql="SELECT * FROM users WHERE ROLEE=3 ORDER BY USER_NAME DESC";
                        ...
                        if($students){
                            ...
                            for($i=0;$i<$rowCount;$i++){
                                ...
                                echo "<tr>
                                        ...
                                        <td class='action-btn'><a href='update_user.php?id=".$stud['USER_ID']."&rolee=student&tab=manage-students' class='update-btn'>Update</a><a href='delete.php?id=".$row['USER_ID']."&rolee=student&tab=manage-students' class='delete-btn'>Delete</a></td>
                                    </tr>";
                            }
                        }
                        ...
                        if($subjectTable){
                            ...
                            for($i=0;$i<$rowCount;$i++){
                                ...
                                echo "<tr>
                                        ...
                                        <td>".$teacherName."</td>
                                        <td class='action-btn'><a href='update_user.php' class='update-btn'>Update</a><a href='delete.php?id=".$subject['SUBJECT_ID']."&rolee=subject&tab=manage-subjects' class='delete-btn'>Delete</a></td>
                                    </tr>";
                            }
                        }
