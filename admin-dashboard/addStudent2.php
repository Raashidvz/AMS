            ...
            for($i=0;$i<count($_FILES['fileUpload']['name']);$i++){
                ...
                if(in_array($file_extension,$allowed_ext)){
                    ...
                    for($row=2;$row<=$lastRow;$row++){
                        ...
                        if($username){
                            $sql = "INSERT INTO users (USER_NAME, PASSWORDD, EMAIL,ROLEE,NAMEE) VALUES ('$username', '$username', '$email','3', '$studentName')";
                            ...
                            if($data){
                                 ...
                                 if($data2){
                                    ...
                                    echo ($row[0]);
                                    $sql3="INSERT INTO students (USER_ID, CLASS_NAME, SEMESTER, PARENT_CONTACT) VALUES ('$key[0]','$className','$semester','$parentContact')";
